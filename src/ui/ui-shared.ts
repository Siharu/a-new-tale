...
export function createNoiseCanvas(opacity: number): HTMLCanvasElement {
...
export const WRONGNESS_PALETTE: Record<WrongnessState, WrongnessPalette> = {
...
export function applyThemeVars(wrongness: WrongnessState): void {

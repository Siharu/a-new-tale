...
export class DrifterAudio {
  ...
  startAmbient(wrongness: WrongnessState = WrongnessState.GREY): void {
    if (this.ambientRunning) { this.applyWrongness(wrongness); return; }
  ...
  private staticBurst(ctx: AudioContext, out: GainNode, filterFreq: number, startOffset: number, duration: number): void {
